        ...
        <div class="col-md-12">
            <form method="POST" class="form" action="{{ route('questionnaireOneSubmit') }}">
                ...
                <div class="ml-4">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_2" name="condition_2" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_2"> Afecciones pulmonares</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_3" name="condition_3" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_3"> Insuficiencia renal</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_4" name="condition_4" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_4"> Lupus</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_5" name="condition_5" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_5"> Cáncer</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_6" name="condition_6" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_6"> Diabetes mellitus</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_7" name="condition_7" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_7"> Obesidad</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_8" name="condition_8" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_8"> Insuficiencia hepática o metabólica</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_9" name="condition_9" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_9"> Asma</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_10" name="condition_10" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_10"> Fibromialgia</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_11" name="condition_11" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_11"> Trombosis venosa profunda</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_12" name="condition_12" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_12"> Antecedentes de infarto al miocardio</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_13" name="condition_13" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_13"> Antecedentes de eventos cerebro vasculares</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_14" name="condition_14" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_14"> Enfermedad cardíaca</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_15" name="condition_15" value="Hipertensión arterial">
                        <label class="custom-control-label" for="condition_15"> Mujer embarazada</label>
                    </div>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="condition_16" name="condition_16" value="Hipertensión arterial">
                ...
                <div class="ml-4">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="circumstance_1" name="circumstance_1" value="Personal de Salud que atienden de manera directa a pacientes con COVID-19">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="circumstance_2" name="circumstance_2" value="Hipertensión arterial">
